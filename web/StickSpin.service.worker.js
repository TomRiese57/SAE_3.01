...
/** @type {string} */
const CACHE_VERSION = '1736954867|1093839835';
/** @type {string} */
const CACHE_PREFIX = 'StickSpin-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'StickSpin.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["StickSpin.html","StickSpin.js","StickSpin.offline.html","StickSpin.icon.png","StickSpin.apple-touch-icon.png","StickSpin.worker.js","StickSpin.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["StickSpin.wasm","StickSpin.pck"];
